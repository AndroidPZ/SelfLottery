...
public class CameraView extends FrameLayout {
    ...
    private int detect(byte[] data, final int rotation) {
        ...
        if (previewFrame.top < 0) {
            ...
            int topInFrame = ((adjustedPreviewHeight - frameRect.height()) / 2) * getWidth() / previewFrame.width();
            int bottomInFrame = ((adjustedPreviewHeight + frameRect.height()) / 2) * getWidth() / previewFrame.width();
            ...
            if (previewFrame.left < 0) {
                ...
                int leftInFrame = ((adjustedPreviewWidth - maskView.getFrameRect().width()) / 2) * getHeight() / previewFrame.height();
                int rightInFrame = ((adjustedPreviewWidth + maskView.getFrameRect().width()) / 2) * getHeight() / previewFrame.height();
...
//        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        hintViewTextWrapper.layout(hintViewLeft, hintViewTop, hintViewLeft + hintViewWidth, hintViewTop + hintViewHeight);
