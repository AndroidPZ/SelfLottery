 ...
 */
public class SelectK3PopupWindow extends PopupWindow {

    private final View mMenuView;
    private final GridView mGridView;
    private final Activity mContext;
    private final SelectGridViewAdapter mAdapter;
    // 设为false可以控制dismiss()无参方法不调用 主要是为了点击PopupWindow外部不消失
    boolean canDismiss = true;
    int selectorPosition = 0;


    public SelectK3PopupWindow(final Activity context, final OnPopUpListener onPopUpListener) {
        super(context);
        ...
        final String[] stringArray = mContext.getResources().getStringArray(R.array.k3msgList);
