 ...
 */
public class SelectTDPopupWindow extends PopupWindow {
    ...
    public SelectTDPopupWindow(final Activity context, final OnPopUpListener onPopUpListener) {
        super(context);
        ...
        final String[] stringArray = mContext.getResources().getStringArray(R.array.sdmsgList);
