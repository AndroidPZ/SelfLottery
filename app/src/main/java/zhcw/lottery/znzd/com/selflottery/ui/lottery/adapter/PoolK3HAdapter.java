...
//选号容器用Adapter（双色球的红球）
public class PoolK3HAdapter extends BaseAdapter {
    ...
    public PoolK3HAdapter(Context context, int endNum, List<Integer> slectedNums, int slectedBgResId, int textColorBgResId) {
        super();
