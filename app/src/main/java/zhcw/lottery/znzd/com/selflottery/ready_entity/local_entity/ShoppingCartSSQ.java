...
//购物车
public class ShoppingCartSSQ {
    private static ShoppingCartSSQ instance = new ShoppingCartSSQ();

    private ShoppingCartSSQ() {
    }

    public static ShoppingCartSSQ getInstance() {
        return instance;
    }
    ...
    private List<TicketSSQ> ticketSSQS = new ArrayList<TicketSSQ>();//投注号码，注与注之间^分割
    private Integer lotterynumber;// 计算，注数
    private Integer lotteryvalue;//方案金额，以分为单位


    public List<TicketSSQ> getTicketSSQS() {
        return ticketSSQS;
    }
