...
public class ActionSheetDialog {
    ...
    public ActionSheetDialog builder() {
        // 获取Dialog布局
        View view = LayoutInflater.from(context).inflate(R.layout.view_toast_actionsheet, null);
        // 设置Dialog最小宽度为屏幕宽度
...
//                        textView.setBackgroundResource(R.drawable.actionsheet_top_selector);
    ...
    public enum SheetItemColor {
        Blue("#5d89f2"), Red("#FD4A2E"),Gray("#bfbfbf"),Green("#33cbcc"),Black("#323334");
        private String name;
