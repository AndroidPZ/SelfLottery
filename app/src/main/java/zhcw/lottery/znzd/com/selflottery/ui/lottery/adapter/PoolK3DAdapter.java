...
//选号容器用Adapter（双色球的红球）
public class PoolK3DAdapter extends BaseAdapter {
    ...
    public PoolK3DAdapter(Context context, int endNum, List<Integer> slectedNums, int slectedBgResId, int textColorBgResId) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.ball.setText(String.format("%s", position + 1));
