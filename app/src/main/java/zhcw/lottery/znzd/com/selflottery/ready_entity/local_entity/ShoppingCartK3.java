...
//购物车 3D
public class ShoppingCartK3 {
    private static ShoppingCartK3 instance = new ShoppingCartK3();

    private ShoppingCartK3() {
    }

    public static ShoppingCartK3 getInstance() {
        return instance;
    }
    ...
    private List<TicketK3> ticketK3 = new ArrayList<TicketK3>();//投注号码，注与注之间^分割
    private Integer lotterynumber;// 计算，注数
    private Integer lotteryvalue;//方案金额，以分为单位


    public List<TicketK3> getTicketK3() {
        return ticketK3;
    }
