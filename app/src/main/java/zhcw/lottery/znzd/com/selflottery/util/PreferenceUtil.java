...
public class PreferenceUtil {
    ...
    public static String PREFERENCE_NAME = "SelfLottery";
    ...
    public static PreferenceUtil getInstance() {
        if (shareData == null) {
            shareData = new PreferenceUtil(App.getInstance());
        }
        return shareData;
    }
    ...
    public void initPreferences() {
        if (this.sharedPreferences == null)
            this.sharedPreferences = mContext.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
    }
