package zhcw.lottery.znzd.com.selflottery.widgets.pswkeyboard.adapter;
 ...
 * @author XPZ
 */
public class KeyBoardBeiAdapter extends BaseAdapter {


    private Context mContext;
    private ArrayList<Map<String, String>> valueList;

    public KeyBoardBeiAdapter(Context mContext, ArrayList<Map<String, String>> valueList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.grid_item_bei_keyboard, null);
        ...
        if (position == 12) {
            ...
            if (position < 3) {
                viewHolder.btnKey.setTextColor(mContext.getResources().getColor(R.color.red_900));
            }
            viewHolder.imgDelete.setVisibility(View.INVISIBLE);
            viewHolder.btnKey.setVisibility(View.VISIBLE);
            viewHolder.btnKey.setText(valueList.get(position).get("name"));
