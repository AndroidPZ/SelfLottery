...
public class ShoppingCartSD {
    private static ShoppingCartSD instance = new ShoppingCartSD();

    private ShoppingCartSD() {
    }

    public static ShoppingCartSD getInstance() {
        return instance;
    }
    ...
    private List<TicketSD> ticketSD = new ArrayList<TicketSD>();//投注号码，注与注之间^分割
    private Integer lotterynumber;// 计算，注数
    private Integer lotteryvalue;//方案金额，以分为单位


    public List<TicketSD> getTicketSD() {
        return ticketSD;
    }
