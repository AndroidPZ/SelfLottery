package zhcw.lottery.znzd.com.selflottery.widgets.imagepicker;
 ...
 * description:
 */
public class MyImageGridActivity extends ImageBaseActivity implements MyImageDataSource.OnImagesLoadedListener
            ...
            if (directPhoto) {
                if (!(checkPermission(Manifest.permission.CAMERA))) {
                    ActivityCompat.requestPermissions(this,
                            new String[]{Manifest.permission.CAMERA}, MyImageGridActivity.REQUEST_PERMISSION_CAMERA);
                } else {
...
//        mImageGridAdapter = new ImageGridAdapter(this, null);
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN) {
            if (checkPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                new MyImageDataSource(this, null, this);
            } else {
    ...
    public void onClick(View v) {
        ...
        if (id == com.lzy.imagepicker.R.id.btn_ok) {
            ...
            if (mImageFolders == null) {
                Logger.i("ImageGridActivity", "您的手机没有图片");
                return;
            }
            //点击文件夹按钮
            ...
            Intent intent = new Intent(MyImageGridActivity.this, ImagePreviewActivity.class);
...
//            intent.putExtra(ImagePicker.EXTRA_IMAGE_ITEMS, imagePicker.getCurrentImageFolderItems());
            ...
            if (imagePicker.isCrop()) {
                Intent intent = new Intent(MyImageGridActivity.this, ImageCropActivity.class);
